    ...
    return (
        <div className="flex h-screen items-center justify-center">
            <div className="flex w-full max-w-xl flex-col items-center px-3">
                ...
                <Link href="/" className="mt-5 flex cursor-pointer items-center gap-1.5 rounded-full bg-[#35353F] px-5 py-3.5 transition duration-200 hover:bg-[#35353F]/90 font-bold" aria-label="Go home">
